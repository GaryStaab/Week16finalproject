...
import RctUpdate from "./rct-update-modal";


export default class RctItem extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <>
                <tr>
                    <td width={'30%'}>{this.props.Data.poNum}</td>
                ...
                <tr>
                    <td width={'30%'}></td>
                    <td width={'30%'}></td>
                    <td width={'30%'}><RctUpdate key={this.props.id} id={this.props.id} data={this.props.Data} updateTransaction={this.props.updateTransaction} /></td>
