                    ...
                    <Form>
                        <Form.Group>
                            <Row>
                                ...
                                <Col xs="8"><Form.Control type="text" value={data.poNum} placeholder="PO Num" id="poNum" onChange={handleChange} size="sm" /></Col>
                            </Row>
                            <Row>
